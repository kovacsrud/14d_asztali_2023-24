...
public partial class MagyarTelepulesekV2Context : DbContext
{
    public MagyarTelepulesekV2Context()
    {
    }

    public MagyarTelepulesekV2Context(DbContextOptions<MagyarTelepulesekV2Context> options)
        : base(options)
    {
    }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        ...
        => optionsBuilder.UseMySql("server=localhost;port=3306;user=root;database=magyar_telepulesek_v2", Microsoft.EntityFrameworkCore.ServerVersion.Parse("10.4.27-mariadb"));
